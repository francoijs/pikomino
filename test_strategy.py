...
from strategy import transition,sortedlist,find_candidates
...
class TestStrategy(TestCase):
    ...
    def test_find_candidates(self):
        ...
        for d in data:
            ...
            small = d[0][2]
            cands = d[1]
            state = ( [small],[21],[], dices,roll )
#            print state
            self.assertEqual(find_candidates(state), cands)
    ...
    def test_transition(self):
        ...
        for d in data:
            ...
            action = d[1]
            out = d[2]
            self.assertEqual(transition(inp,action)[:4], out[:4])
